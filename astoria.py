...
links = [
    "https://astoria-trade.com/bastenska-oprema-alati/makaze-za-orezivanje-duge/makaze-lowe-69080/",
    "https://astoria-trade.com/bastenska-oprema-alati/makaze-za-orezivanje-duge/makaze-lowe-71080/",
    "https://astoria-trade.com/bastenska-oprema-alati/makaze-za-orezivanje-duge/makaze-vinogradarske-lowe-60cm/"
]
...
def getInfo(link):
    driver.get(link)
    try:
        name = driver.find_element_by_xpath('/html/body/div[1]/div/div/div/div/div[3]/div[1]/div[2]/div/div/div[2]/div/h1')
        main_title = name.get_attribute('innerHTML')
        try:
            table = driver.find_element_by_xpath('/html/body/div[1]/div/div/div/div/div[3]/div[1]/div[2]/div/div/div[2]/div/div[1]/p')
            table_str = table.get_attribute('innerHTML')
        except:
            try:
                table = driver.find_element_by_xpath('/html/body/div[1]/div/div/div/div/div[3]/div[1]/div[2]/div/div/div[2]/div/div[1]/p[1]')
                table_str = table.get_attribute('innerHTML')
            except:
               table_str = ""
        ...
        img = driver.find_element_by_xpath('/html/body/div[1]/div/div/div/div/div[3]/div[1]/div[2]/div/div/div[1]/div/div/div/figure/div[1]/div/div/div/figure/a/img')
