...
links = [
    "https://www.agro-ferticrop.rs/dubriva/yara/kalijumova-dubriva/krista-sop",
    "https://www.agro-ferticrop.rs/dubriva/yara/magnezijumova-djubriva/krista-mag-0",
    "https://www.agro-ferticrop.rs/dubriva/yara/magnezijumova-djubriva/krista-mgs-0",
    "https://www.agro-ferticrop.rs/dubriva/yara/kalcijumova-dubriva/yaraliva-calcinit",
    "https://www.agro-ferticrop.rs/dubriva/yara/kalcijumova-dubriva/yaraliva-tropicote",
    "https://www.agro-ferticrop.rs/dubriva/yara/fosforna/krista-mkp-0",
    "https://www.agro-ferticrop.rs/dubriva/yara/helati/yara-vita-rexolin-q40",
    "https://www.agro-ferticrop.rs/dubriva/yara/helati/yara-vita-rexolin-zn",
    "https://www.agro-ferticrop.rs/dubriva/yara/helati/yara-vita-rexolin-mn",
    "https://www.agro-ferticrop.rs/dubriva/ks/kalijumova-dubriva/kalisop",
    "https://www.agro-ferticrop.rs/dubriva/ks/kalijumova-dubriva/patentkali",
    "https://www.agro-ferticrop.rs/dubriva/ks/magnezijumova-dubriva/epso-top",
    "https://www.agro-ferticrop.rs/dubriva/memon/organska-dubriva/fertor-0",
    "https://www.agro-ferticrop.rs/dubriva/memon/organska-dubriva/siforga-0"
]
...
def getInfo(link):
    driver.get(link)
    try:
        name = driver.find_element_by_xpath('/html/body/div[1]/div/section[3]/div/div[1]/h1/span')
        main_title = name.get_attribute('innerHTML')
        try:
            table = driver.find_element_by_xpath('/html/body/div[1]/div/section[3]/div/div[2]/article/div[2]/div/div[1]/div[2]/p')
            table_str = table.get_attribute('innerHTML')
        except:
            try:
                table = driver.find_element_by_xpath('/html/body/div[1]/div/section[3]/div/div[2]/article/div[1]/div[2]/div[1]/div/div/p')
                table_str = table.get_attribute('innerHTML')
            except:
        ...
        img = driver.find_element_by_xpath('/html/body/div[1]/div/section[3]/div/div[2]/article/div[1]/div[1]/div[1]/div/div/img')
